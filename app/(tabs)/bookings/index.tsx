...
function formatDateRange(start: string, end: string): string {
  ...
  if (s.toDateString() === e.toDateString()) {
    return s.toLocaleDateString('en-PH', opts);
  }
...
function BookingCard({
  ...
  const emoji      = CATEGORY_EMOJI[item.listing_category] ?? '📦';
        ...
        <View style={styles.actionRow}>
          ...
          {item.status === 'confirmed' && (
            <TouchableOpacity style={styles.msgBtn} activeOpacity={0.85}>
              ...
              <AppText variant="label" weight="bold" color={Colors.primary} style={{ marginLeft: 4 }}>
                Message
              </AppText>
            </TouchableOpacity>
          )}
          ...
          {item.status === 'completed' && (
            <TouchableOpacity style={styles.reviewBtn} activeOpacity={0.85}>
              ...
              <AppText variant="label" weight="bold" color={Colors.amber} style={{ marginLeft: 4 }}>
                Review
              </AppText>
            </TouchableOpacity>
          )}
      ...
      [
        { text: 'Keep booking', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            if (error) {
              toast.show('Failed to cancel booking. Please try again.', 'error');
            } else {
